...
def load_staff():
    ...
    def make_predict(params_house):
        ...
        params_house[0][0] = pd.to_datetime(params_house[0][0])
        params_house[0][-1] = region_name_to_id_dict[params_house[0][-1]]
        ...
        return CostPrediction(score = model.predict(sample)[0])
